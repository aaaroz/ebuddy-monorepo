        ...
        const users = [
            {
                ...
                priorityScore: 4.3 * 1000000 + 30 * 1000 + 1738938812 / 1000,
            },
            {
                id: "user2",
                ...
                priorityScore: 4.3 * 1000000 + 30 * 1000 + 1738679612 / 1000,
            },
            {
                id: "user3",
                ...
                numberOfRents: 28,
                recentlyActive: 1738679612,
                priorityScore: 4.3 * 1000000 + 28 * 1000 + 1738679612 / 1000,
            },
        ];

        console.log("Starting to seed users...");
        console.log(
            "Connected to Firestore at:",
