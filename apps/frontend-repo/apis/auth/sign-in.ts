...
import { storeCredentialsToCookie } from '@/service/auth-service';
import { TAuthResponse } from "@/lib/types/auth";

export async function signIn({ password, email }: Omit<TSignInSchema, 'showPassword'>): Promise<TAuthResponse> {
    try {
